    ...
    return (
        <div className="relative font-sans">
            ...
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group"
            >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full right-0 mt-4 w-[350px] sm:w-[400px] h-[500px] bg-white dark:bg-[#151926] border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden z-[9999]"
                    >

                        {/* Header */}
                        <div className="p-4 bg-indigo-600 flex items-center justify-between shrink-0 shadow-md z-10 relative">
