...
export default function FeaturedAds() {
    ...
    const ads = [
        {
            id: 1,
            title: labels.ads.summer_paris,
            subtitle: labels.ads.summer_paris_desc,
        ...
        {
            id: 2,
            title: labels.ads.business_upgrade,
            subtitle: labels.ads.business_upgrade_desc,
        ...
        {
            id: 3,
            title: labels.ads.tokyo_adventure,
            subtitle: labels.ads.tokyo_adventure_desc,
    ...
    return (
        <section className="relative z-20 py-12 px-4 max-w-7xl mx-auto">
            <div className="flex items-center gap-2 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
                ...
                <h2 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white tracking-tight">{labels.experience.highlights}</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {ads.map((ad, index) => (
                    ...
                    >
                        ...
                        {/* Gradient Overlay */}
                        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent group-hover:from-black/40 transition-all" />
                        ...
                        <div className="absolute inset-0 p-6 flex flex-col justify-end">
                            ...
                            <div className="flex items-center gap-2 text-sm font-bold text-white opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                                {labels.ads.view_offer} <ArrowRight className="w-4 h-4 ml-1" />
                            </div>
                        </div>
